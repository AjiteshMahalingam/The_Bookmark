...
// To set default values we can assign 'em while destructuring the props. Ex color="blue"
Rating.defaultProps = {
    color : '#141f1f'
}

// This is not essential !!
// Warning is passed to the browser console when invalid prop type passed.
Rating.propTypes = {
